                    ...
                    <div className="mb-10 flex items-center justify-between flex-wrap gap-6">
                        <div className="flex items-center gap-6">
                            ...
                            <div>
                                ...
                                >
                                    Get an overview of all scans running and navigate your way to vulnerabilities!
                                </Typography>
                            </div>
                        </div>
                        <div className="w-96">
                                    ...
                                    <tbody>
                                        {scans.map(
                                            ({ img, id, name, scope, power, completion }, key) => {
                                                const className = `py-3 px-5 ${key === scans.length - 1
                                                    ? ""
                                                    ...
                                                    <tr key={name}>
                                                        ...
                                                        <td className={className}>
                                                            <div className="flex items-center gap-4">
                                                                <Button name={id} onClick={navigateToScanDetails}>{name}</Button>
                                                            </div>
                                                        </td>
                                                        <td className={className}>
                                                            <p className='flex'>
                                                                {scope.split(",").map((name, key) => (
                                                                    <Tooltip key={name} content={name}>
                                                                        <LinkIcon className={`cursor-pointer w-6 border-2 border-white rounded-full ${key === 0 ? "" : "-ml-2.5"}`} />
                                                                    </Tooltip>
                                                                ))}
                                                            </p>
                                                        </td>
                                                        <td className={className}>
                                                            <Chip value={power === 1 && 'low' || power === 2 && 'medium' || power === 3 && 'high'} className='rounded-full w-auto' variant='ghost' color={power === 1 && 'green' || power === 2 && 'orange' || power === 3 && 'red'} />
                                                        </td>
                                                        <td className={className}>
