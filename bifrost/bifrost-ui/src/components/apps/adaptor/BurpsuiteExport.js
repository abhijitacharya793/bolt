...
export default function BurpsuiteExport() {
    ...
    return (
        <>
            ...
            <div className="mb-12 grid gap-12 px-4 py-8 grid-cols-1 place-items-center">
                <Card className="w-full max-w-[24rem]">
                    <CardBody>
                        <form className="flex flex-col gap-4">
                            ...
                            <Button size="lg" onClick={handleSubmit}>Scan Now</Button>
                            <Typography
                                variant="small"
                                color="gray"
                                className="mt-2 flex items-center justify-center gap-2 font-medium opacity-60"
                            >
                                <PlayIcon className="-mt-0.5 h-4 w-4" /> This will
